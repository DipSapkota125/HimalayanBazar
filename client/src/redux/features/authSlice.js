...
export const register = createAsyncThunk(
  ...
  async ({ formData, toast, navigate }, { rejectWithValue }) => {
    try {
      ...
      toast.success(response.data.message || "user register success!");
      navigate("/login");
...
export const login = createAsyncThunk(
  ...
  async ({ loginValue, toast, navigate }, { rejectWithValue }) => {
    try {
      ...
      toast.success(response.data.message || "user login success!");
...
export const { clearError, setLogout, setUser, clearUser } = authSlice.actions;
