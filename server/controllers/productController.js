...
export const categoryProducts = tryCatchAsyncError(async (req, res, next) => {
...
//single admin products
export const singleAdminProduct = tryCatchAsyncError(async (req, res, next) => {
